...
| [`outils/visuels-store.html`](outils/visuels-store.html) | **Fabriquer les visuels des stores** — une page à ouvrir en local, rien ne part sur Internet |
...
| [`docs/system-design.md`](docs/system-design.md) | **Monter en compétence** — 32 patrons, chacun avec son renvoi vers le code, plus ceux qu'on a mesurés puis écartés |
