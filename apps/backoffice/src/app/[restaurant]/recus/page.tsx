/**
 * Les REÇUS — l'historique des ventes, et le détail de l'une d'elles.
 *
 * « Reçu » et non « ticket » : c'est le mot de Loyverse, et surtout celui
 * que le client emploie quand il revient contester un montant. Le ticket,
 * lui, désigne le papier ; l'écran, désormais, porte le nom de la chose.
 *
  ...
  return (
    <>
      ...
      <BoutonsExport
        ...
        exports={[{ quoi: 'tickets', libelle: 'Reçus' }]}
        du={periode.du}
        au={periode.au}
      />
