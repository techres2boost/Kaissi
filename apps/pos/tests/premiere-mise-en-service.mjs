#!/usr/bin/env node
/**
 * PREMIÈRE mise en service d'une caisse qui a déjà servi en local.
 *
 * Complément de `mise-en-service.mjs`, qui vérifie qu'un refus VENANT DU
 * SERVEUR (403) arrive à l'écran. Celui-ci part du cas inverse : le serveur
 * dit oui, et c'est la caisse elle-même qui a quelque chose à dire.
 *
 ...
 *   node apps/pos/tests/premiere-mise-en-service.mjs
 */
